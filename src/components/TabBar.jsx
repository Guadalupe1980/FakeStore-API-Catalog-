...
function TabBar() {
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 border-t border-slate-300 flex justify-around items-center bg-white text-[12px] text-gray-400 font-semibold tracking-wider p-3 shadow-md md:hidden">
        ...
        <button className="flex flex-col items-center justify-center gap-1 w-16 h-full text-slate-400 hover:text-blue-700 active:scale-95 transition-transform">
          <svg
            ...
            fill="currentColor"
          >
            <path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-240v-80q0-34 17.5-62.5T224-426q62-31 126.5-45.5T480-486q66 0 130.5 14.5T736-426q29 14 46.5 42.5T800-320v80H160Z" />{" "}
          </svg>
          PROFILE
        </button>
      </nav>
